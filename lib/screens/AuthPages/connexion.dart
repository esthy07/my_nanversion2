               ...
               /* Container(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        child: Text("Email ou Nom d'utilisateur", style: TextStyle(
                          fontFamily: 'Barlow', fontSize: 18, fontWeight: FontWeight.w600
                        ),),
                      ),
                      Container(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text('Connexion', style: TextStyle(
                              color: Colors.white, fontFamily: 'Barlow', fontWeight: FontWeight.bold, fontSize: 18
                            ),),
                          ),
                        ),
                      )
